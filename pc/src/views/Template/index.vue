<template>
  <div id="ascii-container">
    <div id="logo-interstitial" class="animated fadeOut">
      <img src="~@assets/images/logo-full.gif" class="animated bounceOut" />
    </div>

    <img id="logo-bar" src="~@assets/images/logo-bar.gif" width="88" height="24" />
    ...
    <div id="options-button-dialog" class="dialog">
      <div id="options-scroll">
          <img id="options-logo" src="~@assets/images/logo-options.gif" width="176" height="48" />
            <br>
    ...
    <div id="drive-dialog" class="dialog">
      ...
      <div style="margin: 5px;">Edit permissions and manage files in.</div>
      <br>
...
.box-image { background-image: url('~@assets/images/box-icon.gif'); }
.line-image { background-image: url('~@assets/images/line-icon.gif'); }
.arrow-image { background-image: url('~@assets/images/arrow-icon.gif'); }
.freeform-image { background-image: url('~@assets/images/freeform-icon.gif'); }
.erase-image { background-image: url('~@assets/images/erase-icon.gif'); }
.move-image { background-image: url('~@assets/images/move-icon.gif'); }
.text-image { background-image: url('~@assets/images/text-icon.gif'); }

.drive-image { background-image: url('~@assets/images/drive-icon.gif'); }
.export-image { background-image: url('~@assets/images/export-icon.gif'); }
.import-image { background-image: url('~@assets/images/import-icon.gif'); }
.clear-image { background-image: url('~@assets/images/clear-icon.gif'); }
.undo-image { background-image: url('~@assets/images/undo-icon.gif'); }
.redo-image { background-image: url('~@assets/images/redo-icon.gif'); }
.select-image { background-image: url('~@assets/images/select-icon.gif'); }

.info-image { background-image: url('~@assets/images/info-icon.gif'); }
